...
local web = true
local user = "frontwarerbx" -- change if you're using a fork
...
local releaseInfo = HttpService:JSONDecode(game:HttpGetAsync("https://api.github.com/repos/" .. user .. "/Peroxide/releases"))[1]
