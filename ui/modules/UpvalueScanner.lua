...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Peroxide's Upvalue Scanner: https://github.com/frontwarerbx/Peroxide

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/frontwarerbx/Peroxide/revision/ohaux.lua"))()
