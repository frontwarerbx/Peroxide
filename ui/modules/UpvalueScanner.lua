...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Peroxide's Upvalue Scanner: https://github.com/Upbolt/Peroxide

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Upbolt/Peroxide/revision/ohaux.lua"))()
